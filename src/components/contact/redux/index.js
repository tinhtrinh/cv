...
import AppModuleHeader from '../../AppModuleHeader/index';
    ...
    return <div className="module-side">
      <div className="module-side-header">
        <div className="module-logo">
          ...
          <span><IntlMessages id="Contacts"/></span>
        </div>
      </div>
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    onSaveContact: (data) => {
      dispatch(onSaveContact(data));
    },
    onDeleteContact: (data) => {
      dispatch(onDeleteContact(data));
    },
    onDeleteSelectedContact: () => {
    ...
    onAllContactSelect: () => {
      dispatch(onAllContactSelect());
    },
    updateContactUser: (userName) => {
      dispatch(updateContactUser(userName));
    },
    onToggleDrawer: () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContactWithRedux);