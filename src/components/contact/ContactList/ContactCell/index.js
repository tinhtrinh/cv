...
class ContactCell extends React.Component {
  ...
  render() {
    ...
    const {name, studentid, thumb, email, phone, designation, address, specialized, starred} = contact;
      ...
      <div className="contact-item">
        ...
        <div className="col con-inf-mw-100">
          ...
          <div className="text-muted">
            ...
            <span className="phone d-inline-block mr-2">
                            {phone},
                        </span>
            
            <span className="address d-inline-block">
                            {address}
                        </span>
          </div>
        </div>
